...
// Mock BlogGrid component since the actual one isn't available
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Discover the latest insights, tips, and stories from our expert
            writers.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {["Web Development", "Design", "Technology", "Programming"].map(
              (category) => (
                <Link
                  key={category}
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 mt-2">Explore articles</p>
                </Link>
              ),
            )}
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">BlogMaster</h3>
              <p className="text-gray-400">
                A modern blog platform for sharing knowledge and insights.
              </p>
            </div>
